...
# curl -H "Content-Type: application/json" -X POST -d '{"data": {"chapters": {"delete": [{"id": 2},{"id": 3}], "update": [{"id": 1, "order": 1, "stylesheet": "<dingle mcringleberry>", "title": "I got updated!", "content": "Beep boop", "release_date": "2016-10-01 12:30:00", "authors_note": "wao"}]}, "entries": {"delete": [{"id": 2}], "update": [{"id": 1, "order": 1, "title": "I got updated!", "content": "Hinkle dinkle doo", "release_date": "2016-10-01 12:30:00", "authors_note": "Womp"}], "create": [{"chapter_id": 1, "order": 1, "title": "Entry #1", "content": "Hinkle dinkle doo", "release_date": "2016-10-01 12:30:00", "authors_note": "Womp"},{"chapter_id": 1, "order": 2, "title": "Entry #2", "content": "Hinkle dinkle doo", "release_date": "2016-10-01 12:30:00", "authors_note": "Wimp"}]}}, "secretKey": "hello"}' http://localhost:4567/api/batch
...
@chapter3.entries.create(order: 1, title: "Entry #1", level: 1, content: "Hinkle dinkle domp", release_date: "2016-10-02 12:30:00", authors_note: "Womp")
@chapter3.entries.create(order: 2, title: "Entry #2", level: 2, content: "Hinkle dinkle womp", release_date: "2016-10-02 12:30:00", authors_note: "Wimp")
